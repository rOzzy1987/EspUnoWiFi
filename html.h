    ...
    <div id="msgBar">
        ...
        <div>
            ...
            <select id="lef">
                ...
                <option selected="selected">Newline</option>
    ...
    <script>
        var updateBaudrate = function (baudrate) {
            ...
            getBaudrate.onload = function () {
                document.getElementById("baudtxt").value = this.responseText;
            };
        ...
        document.getElementById("baudtxt").onchange = function () {
            updateBaudrate(this.value);
        }

        document.getElementById("baud").onchange = function () {
            if (document.getElementById("baudtxt").value != this.value) {
                document.getElementById("baudtxt").value = this.value;
                document.getElementById("baudtxt").onchange();
            }
        };
        document.getElementById("baud").onclick = function () {
            document.getElementById("baud").selectedIndex = -1;
        };
